...
void	print_var(t_mlx *mlx)
{
	...
	mlx_string_put(mlx->mlx_ptr, mlx->win_ptr, 840, 220, 0xFFFFFF,
		"Iterations max : ");
...
void	menu_gradient(t_leg leg, t_mlx *mlx)
{
	...
	mlx_string_put(mlx->mlx_ptr, mlx->win_ptr, 860, 640, 0xFFFFFF,
		"BLEU  ROSE  NOIR  ROUGE ");
	mlx_string_put(mlx->mlx_ptr, mlx->win_ptr, 900, 665, 0xFFFFFF, "OU MULTI :");
	mlx_string_put(mlx->mlx_ptr, mlx->win_ptr, 860, 690, 0xFFFFFF,
		"ROSE  VERT  JAUNE");
